...
ex_model = 3;                                                              % exchange coefficients rate model
...
e_STELLAR = cell(3,1);
if isunix
    fileID1 = fopen('/home/ksusha/Desktop/Cloud Mail.Ru/S-t-s/Matlab/MAT/STELLAR/N2-X-v61-Levels-Leroy2006.txt');
    fileID2 = fopen('/home/ksusha/Desktop/Cloud Mail.Ru/S-t-s/Matlab/MAT/STELLAR/O2-X-v46-Levels-RKR.txt');
    fileID3 = fopen('/home/ksusha/Desktop/Cloud Mail.Ru/S-t-s/Matlab/MAT/STELLAR/NO-X-v48-Levels-RKR.txt');
else 
    fileID1 = fopen('C:\Users\Ksusha\Desktop\S-t-s\Matlab\MAT\STELLAR\N2-X-v61-Levels-Leroy2006.txt');
    fileID2 = fopen('C:\Users\Ksusha\Desktop\S-t-s\Matlab\MAT\STELLAR\O2-X-v46-Levels-RKR.txt');
    fileID3 = fopen('C:\Users\Ksusha\Desktop\S-t-s\Matlab\MAT\STELLAR\NO-X-v48-Levels-RKR.txt');
end
