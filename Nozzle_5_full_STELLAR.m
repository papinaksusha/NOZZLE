...
[f1,f2] = ode15s(@nozzle_5_NO,x,init,options);
    ...
    k_NO_VT = interp1(e_i_NO_an(1 : end - 1), k_NO_VT, e_i_NO(1 : end - 1), 'spline'); 
    ...
    k_N2_NO_VV = interp2(e_i_NO_an(1 : end - 1), e_i_N2_an(1 : end - 1)', ...
                 k_N2_NO_VV, e_i_NO(1 : end - 1), e_i_N2(1 : end - 1)', 'spline');
    ...
    k_O2_NO_VV = interp2(e_i_NO_an(1 : end - 1), e_i_O2_an(1 : end - 1)', ...
                 k_O2_NO_VV, e_i_NO(1 : end - 1), e_i_O2(1 : end - 1)', 'spline');
    
    k_NO_N2_VV = interp2(e_i_N2_an(1 : end - 1), e_i_NO_an(1 : end - 1)', ...
                 k_NO_N2_VV, e_i_N2(1 : end - 1), e_i_NO(1 : end - 1)', 'spline');
    k_NO_O2_VV = interp2(e_i_O2_an(1 : end - 1), e_i_NO_an(1 : end - 1)', ...
                 k_NO_O2_VV, e_i_O2(1 : end - 1), e_i_NO(1 : end - 1)', 'spline');
    k_NO_NO_VV = interp2(e_i_NO_an(1 : end - 1), e_i_NO_an(1 : end - 1)', ...
                 k_NO_NO_VV, e_i_NO(1 : end - 1), e_i_NO(1 : end - 1)', 'spline');
