...
global k h c w wx m theta_r D I sw_o sw_n ex_model Na L
...
[f1,f2] = ode15s(@nozzle_5,x,init,options);
    ...
    n_c_N2 = ones(l_N2 + 1,1)*[sum(n_N2) sum(n_O2) n_NO n_N n_O].*n_cr; % �� ������ n-cr  � ����� �� ����� �������? ������, �������� ��� ����� ������� ������ �����
    %*  48*5
   ...
   % k_diss_N2 = k_diss_N2'*ones(1,5) ;% ������ ��� �� ����������� ��� �������� 48*5
    ...
    b(1 : l_N2 + 1) = R_N2 - v.*n_N2./S(1).*S(2); 
